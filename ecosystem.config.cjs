  ...
  apps: [
    {
      ...
      env: {
        ...
        CLOVER_ENVIRONMENT: process.env.CLOVER_ENVIRONMENT || 'production',
        CLOVER_MERCHANT_ID: process.env.CLOVER_MERCHANT_ID || '',
        CLOVER_ACCESS_TOKEN: process.env.CLOVER_ACCESS_TOKEN || '',
        CLOVER_PAGE_CONFIG_UUID: process.env.CLOVER_PAGE_CONFIG_UUID || '',
        CLOVER_WEBHOOK_SECRET: process.env.CLOVER_WEBHOOK_SECRET || '',
        CLOVER_BOOKING_DEPOSITS_ENABLED: process.env.CLOVER_BOOKING_DEPOSITS_ENABLED || 'false',
