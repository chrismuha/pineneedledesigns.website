...
.booking-success-card { width: min(100%, 600px); padding: clamp(28px, 5vw, 48px); border-radius: 24px; background: var(--legacy-booking-payment-success-view-booking-success-card-surface); box-shadow: 0 18px 50px var(--legacy-booking-payment-success-view-booking-success-card-shadow); text-align: center; }
.success-mark { display: grid; place-items: center; width: 58px; height: 58px; margin: 0 auto 16px; border-radius: 50%; background: var(--legacy-booking-payment-success-view-success-mark-surface); color: var(--legacy-booking-payment-success-view-success-mark-text); font-size: 2rem; font-weight: 800; }
.calendar-button { display: inline-flex; min-height: 50px; margin: 18px 0 8px; padding: 12px 26px; align-items: center; border-radius: 999px; background: var(--legacy-booking-payment-success-view-calendar-button-surface); color: var(--legacy-booking-payment-success-view-calendar-button-text); font-weight: 800; text-decoration: none; }
.important { color: var(--legacy-booking-payment-success-view-important-text); font-size: .9rem; }
.error { color: var(--legacy-booking-payment-success-view-error-text); font-weight: 700; }
</style>
