...
.booking-deposit-card { width: min(100%, 560px); padding: clamp(24px, 5vw, 44px); border-radius: 24px; background: var(--booking-deposit-view-booking-deposit-card-surface); box-shadow: 0 18px 50px var(--booking-deposit-view-booking-deposit-card-shadow); }
.booking-eyebrow { margin: 0 0 8px; color: var(--booking-deposit-view-booking-eyebrow-text); font-weight: 700; letter-spacing: .08em; text-transform: uppercase; }
h1 { margin: 0 0 14px; }
.booking-intro { margin-bottom: 28px; font-size: 12.6pt; }
.booking-form { display: grid; gap: 16px; }
label { display: grid; gap: 7px; font-weight: 700; }
input { width: 100%; min-height: 46px; padding: 10px 13px; border: 1px solid var(--limited-run-placeholder-end); border-radius: 10px; font: inherit; }
input:focus { border-color: var(--booking-deposit-view-input-border); outline: 3px solid var(--booking-deposit-view-input-focus-ring); }
button { min-height: 50px; margin-top: 4px; border: 0; border-radius: 999px; background: var(--booking-deposit-view-button-surface); color: var(--booking-deposit-view-button-text); font: inherit; font-weight: 800; cursor: pointer; }
button:hover { background: var(--booking-deposit-view-button-surface-2); }
button:disabled { cursor: wait; opacity: .65; }
.booking-fine-print { margin: 18px 0 0; color: var(--booking-deposit-view-booking-fine-print-text); font-size: 10.8pt; text-align: center; }
.booking-notice { margin: 0; color: var(--booking-deposit-view-booking-notice-text); }
.booking-error { margin: 0; color: var(--booking-deposit-view-booking-error-text); font-weight: 700; }
</style>
